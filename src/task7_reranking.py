...
def rerank(
    ...
    if method == "cross_encoder":
        ...
        # RRF gộp nhiều ranked list; khi chỉ có 1 list candidates (đã sorted theo
        # score gốc), coi đó là 1 ranked list duy nhất rồi fuse — cách gọi này
        # dùng để Task 9 chạy rerank() cuối cùng trên kết quả đã merge từ
        # rerank_rrf([dense_results, sparse_results]). Muốn merge nhiều nguồn
        # thật sự thì gọi thẳng rerank_rrf([list1, list2, ...]).
